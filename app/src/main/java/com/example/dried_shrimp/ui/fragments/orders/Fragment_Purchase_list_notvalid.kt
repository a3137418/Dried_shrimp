...
import com.example.dried_shrimp.databinding.FragmentPurchaselistNotvalidBinding
...
class Fragment_Purchase_list_notvalid: Fragment() {
    private var binding: FragmentPurchaselistNotvalidBinding ?=null
    ...
    override fun onCreateView(
        ...
        binding = FragmentPurchaselistNotvalidBinding.inflate(inflater,container,false)
    ...
    private fun setupRecyclerViews() {
        ...
        binding?.recyclePurchaselistNotvalid?.apply {
            ...
            adapter = this@Fragment_Purchase_list_notvalid.adapter
        }
    }
    // ★訂單邏輯
    private fun loadOrders() {
        ...
        db.collection("users").document(userId).collection("orders")
            .whereEqualTo("status", "CANCELLED") // 只要篩選狀態
            .get()
